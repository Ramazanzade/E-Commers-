    ...
    return (
        ...
        <View style={{ display: 'flex', position: 'relative', marginTop: '3%' }}>
            <TextInput
                ...
                style={{ borderColor: 'rgba(234, 234, 234, 1)', borderRadius: 20, textAlign: 'left', paddingLeft: '5%', fontSize: 15, width: SCREEN_WIDTH - 40, alignSelf: 'center', marginTop: '5%', backgroundColor: 'rgba(242, 244, 247, 1)', color:'red' }}
            />
